...
contract Pitch is ERC1155Supply, Ownable {
    ...
    uint256 public constant TOKEN_ID_A = 1;
    uint256 public constant TOKEN_PRICE_A = 0.033 ether;
    uint256 public constant MAX_TOKENS_A = 333;
    uint256 public constant TOKEN_ID_B = 2;
    uint256 public constant TOKEN_PRICE_B = 0.033 ether;
    uint256 public constant MAX_TOKENS_B = 333;
    uint256 public constant TOKEN_ID_C = 3;
    uint256 public constant TOKEN_PRICE_C = 0.033 ether;
    uint256 public constant MAX_TOKENS_C = 333;    
    uint256 public constant TOKEN_ID_D = 4;
    uint256 public constant TOKEN_PRICE_D = 0.033 ether;
    uint256 public constant MAX_TOKENS_D = 333;    
    ...
    constructor(
        ...
        name = _name;
        symbol = _symbol;
        tokenURI[TOKEN_ID_A] = uriA;
        tokenURI[TOKEN_ID_B] = uriB;
        tokenURI[TOKEN_ID_C] = uriC;
        tokenURI[TOKEN_ID_D] = uriD;
    }
    ...
    function setWlSaleState(bool _state) public onlyOwner {
        wlSaleIsActive= _state;
    }
